...
set output "closestAverage.pdf"
set title "Average distance of the closest nodes in the tman to the local node"
...
plot "closestAverage/closestAverage_churn.parse" u ($1):($2) with lines linestyle 1 title "churn",\
     "closestAverage/closestAverage_massive_churn.parse" u ($1):($2) with lines linestyle 2 title "massive churn",\
     "closestAverage/closestAverage_no_churn.parse" u ($1):($2) with lines linestyle 3 title "no churn"
