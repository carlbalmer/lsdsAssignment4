...
set output "staleReferences.pdf"
set title "Average number of stale references"
...
plot "staleReferences/staleReferences_chord_churn.parse" u ($1):($2) with lines linestyle 1 title "Chord - churn",\
     "staleReferences/staleReferences_chord_massive_churn.parse" u ($1):($2) with lines linestyle 2 title "Chord - massive churn",\
     "staleReferences/staleReferences_t_chord_churn.parse" u ($1):($2) with lines linestyle 3 title "T-Chord - massive churn",\
     "staleReferences/staleReferences_t_chord_massive_churn.parse" u ($1):($2) with lines linestyle 4 title "T-Chord - massive churn"
