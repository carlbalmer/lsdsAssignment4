...
set output "hops.pdf"
set title "Hop Distribution"

# indicates the labels
set ylabel "Proportion of Querries (%)"
set xlabel "No. of Hops"
...
plot "hops/hops_tchord.parse" u ($1):($2/1467*100) with lines linestyle 1 title "T-Chord",\
     "hops/hops_chord.parse" u ($1):($2/19992*100) with lines linestyle 2 title "Chord"
